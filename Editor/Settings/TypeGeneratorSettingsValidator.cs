...
namespace AlkimeeGames.TagLayerTypeGenerator.Editor.Settings
{
    ...
    internal static class TypeGeneratorSettingsValidator
    {
        ...
        internal static bool ValidateAll([NotNull] TypeGeneratorSettings.Settings settings) =>
            IsValidNamespace(settings.Namespace) && IsValidTypeName(settings.TypeName) && IsValidFilePath(settings.FilePath);
    }
}